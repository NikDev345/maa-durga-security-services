...
export default function Button({
  ...
  return (
    <button
      type={type}
      className={`group inline-flex items-center justify-center gap-1.5 rounded-sm border px-4 py-2 text-[10px] font-bold uppercase tracking-[0.12em] transition-all duration-300 ${styles} ${className}`}
      {...props}
    >
      <span>{children}</span>
